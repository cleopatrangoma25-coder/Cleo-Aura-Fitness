  ...
  return (
    <section className="space-y-4">
      <div className="rounded-xl border bg-white p-5 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">Log nutrition and wellbeing in under a minute.</p>
      </div>

      <div className="grid gap-3 sm:grid-cols-3">
        <article className="rounded-xl border bg-white p-4 text-center shadow-sm">
      ...
      <form className="grid gap-4 rounded-xl border bg-white p-5 shadow-sm" onSubmit={handleSubmit}>
